...
#ifdef SKYRIMVR
	DEFINE_MEMBER_FN(AddFromMod, void, 0x003F7B40, TESRace *race, TESFile *mod);
	DEFINE_MEMBER_FN(ctor, BGSAttackDataMap*, 0x003F79E0);
#else
	DEFINE_MEMBER_FN(AddFromMod, void, 0x003E7FF0, TESRace *race, TESFile *mod);
	DEFINE_MEMBER_FN(ctor, BGSAttackDataMap*, 0x003E7E90);
#endif
};
